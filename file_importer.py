...
if os.name == 'nt':
    if desktop:
        path = r"C:\DOCUMENTEN\RUG\Master\Master Research Project\Kinematic_Data"
    ...
    path = r"/home/s3488926/Documents/master_project/drive/Kinematic_Data"
    print("Linux path used")

steps = '_00_'
t_total = 5

N_frames, data, i, legs = 200*t_total, {}, 0, ['R1', 'R2', 'R3', 'L1', 'L2', 'L3']
        ...
        for filename in file_list:
            ...
            try:
                ...
                if gait.size > N_frames and np.min(N) > 1 and steps in file_path:
                    ...
                    print(f'[1. skipped file: N = {np.min(N)}, gait size, N_frames = {gait.size, N_frames}, {steps} in '
                          f'{steps in file_path}]')
            except:
